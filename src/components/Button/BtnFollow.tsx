    ...
    <>
      {!isMatch ? (
        ...
        <button
          ...
          className='bg-transparent text-textGray hover:text-red-500 border px-2 py-1 border-textGray hover:border-red-500 transition-colors text-xs rounded-2xl whitespace-nowrap'
        >
