...
export const NavBar = () => {
  ...
  return (
    <>
      ...
      <nav
        className='bg-primary/80 backdrop-blur-md fixed bottom-0 sm:sticky sm:inset-0 flex w-full z-50 transition-all
      ...
      >
        <div className='hidden md:flex gap-3 justify-center md:items-center relative bg-transparent'>
          <img
            ...
            alt='bookend'
          />
          <h1 className='text-xl font-medium font-mono hidden lg:block'>Bookend</h1>
          {router.query.username && <button
