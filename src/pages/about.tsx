      ...
      <article className="flex flex-col gap-6 mt-4">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-textGray">
            Bookend is a web application to share books and it was thanks to the
            idea that arose when I was looking to carry out fullstack
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-textGray">
            a social network service is born in one of the great social networks
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-textGray">
            Typescript, nextJS, graphql with apollo client, apollo-server-micro,
            apollo-server, mongoose, mongodb, passport-jwt, postcss, tailwindcss
          </p>
        </div>
