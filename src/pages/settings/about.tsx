      ...
      <section className='w-full p-4 rounded-xl'>
        ...
        <article className='flex flex-col gap-6 mt-4'>
          <div className='flex flex-col gap-2'>
            ...
            <p className='dark:text-textGray'>{translate.about.p1}</p>
          </div>
          <div className='flex flex-col gap-2'>
            <h2 className='text-lg font-bold'>{translate.about.h2}</h2>
            <p className='dark:text-textGray'>{translate.about.p2}</p>
          </div>
          <div className='flex flex-col gap-2'>
            <h2 className='text-lg font-bold'>{translate.about.h3}</h2>
            <p className='dark:text-textGray'>{translate.about.p3}</p>
          </div>
